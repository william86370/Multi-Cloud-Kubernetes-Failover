...
def main():
    ...
    try:
        # Get the daemon set
        daemon_set = v1.read_namespaced_daemon_set(name="cloudwatch-healthcheck", namespace=namespace)
    ...
    try:
        # Get the dashboard
        dashboard = v1.read_namespaced_deployment(name="cloudwatch-dashboard", namespace=namespace)
